...
@section('content')
<div class="h-full ml-14 md:ml-64 bg-white"> 

  <h1 class="text-3xl text-center text-green-500 mb-5">Vos conversations</h2>
  @foreach($conversations as $conversation)
  <a href="{{ route('admin.conversations.show', $conversation->id) }}" class="focus:outline-none">
